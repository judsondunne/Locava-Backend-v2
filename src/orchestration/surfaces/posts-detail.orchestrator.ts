    ...
    return {
      ...
      firstRender: {
        post: {
          ...
          rawPost: post.rawPost ?? post.sourcePost ?? null,
          sourcePost: post.sourcePost ?? post.rawPost ?? null,
          isRoute: (post as { isRoute?: boolean }).isRoute,
          postType: (post as { postType?: string }).postType,
          routeSource: (post as { routeSource?: string }).routeSource,
          undiscoveredRouteId: (post as { undiscoveredRouteId?: string }).undiscoveredRouteId,
          sourceUnexploredRouteId: (post as { sourceUnexploredRouteId?: string }).sourceUnexploredRouteId,
          routeId: (post as { routeId?: string }).routeId,
          routeName: (post as { routeName?: string }).routeName,
          routeActivity: (post as { routeActivity?: string }).routeActivity,
          routeKind: (post as { routeKind?: string }).routeKind,
          routeType: (post as { routeType?: string }).routeType,
          routeSummary: (post as { routeSummary?: Record<string, unknown> }).routeSummary,
          routePreviewCoordinates: (post as { routePreviewCoordinates?: unknown }).routePreviewCoordinates,
          routeCoordinates: (post as { routeCoordinates?: unknown }).routeCoordinates,
          encodedPolyline: (post as { encodedPolyline?: string }).encodedPolyline,
          bbox: (post as { bbox?: unknown }).bbox,
          distanceMeters: (post as { distanceMeters?: number }).distanceMeters,
          route: (post as { route?: Record<string, unknown> }).route,
          capture: (post as { capture?: Record<string, unknown> }).capture,
          privacy: (post as { privacy?: string }).privacy,
          classification: (post as { classification?: Record<string, unknown> }).classification,
