...
export const RECENT_POSTS_PAGE_OVERFETCH_CAP = 120;
export const RECENT_POSTS_PAGE_OVERFETCH_CHAINS = 3;
export const ACTIVITY_MIX_POOL_CAP = 72;
export const NEAR_ME_EXHAUST_MAX_ITERATIONS = 6;
export const NEAR_ME_EXHAUST_MAX_FIRESTORE_READS = 720;
