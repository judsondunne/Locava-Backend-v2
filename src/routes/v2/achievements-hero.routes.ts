...
import { achievementsHeroContract } from "../../contracts/surfaces/achievements-hero.contract.js";
import { canUseV2Surface } from "../../flags/cutover.js";
import { failure, success } from "../../lib/response.js";
import { setRouteName } from "../../observability/request-context.js";
import { AchievementsHeroOrchestrator } from "../../orchestration/surfaces/achievements-hero.orchestrator.js";
...
export async function registerV2AchievementsHeroRoutes(app: FastifyInstance): Promise<void> {
  const service = new AchievementsService(achievementsRepository);
  const orchestrator = new AchievementsHeroOrchestrator(service);

  app.get(achievementsHeroContract.path, async (request, reply) => {
    ...
    setRouteName(achievementsHeroContract.routeName);
